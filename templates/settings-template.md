...
# CURDX Specum Configuration

This file configures CURDX Specum plugin behavior for this project.
...
Create this file at `.claude/curdx.local.md` in your project root to customize plugin behavior.
...
With this setup:
- `/curdx:start my-feature` creates spec in `./specs/` (first configured dir)
- `/curdx:start my-feature --specs-dir ./packages/frontend/specs` creates in frontend
- `/curdx:status` lists all specs from all configured directories
- `/curdx:switch my-feature` prompts if name exists in multiple directories
