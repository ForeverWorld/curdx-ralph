...
> **IMPORTANT**: NEVER push directly to the default branch (main/master). Branch management is handled at startup via `/curdx:start`. You should already be on a feature branch by this phase.
