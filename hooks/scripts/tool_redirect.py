...
from _util import HookTimer, pre_tool_use_context, pre_tool_use_deny
...
def run_tool_redirect() -> int:
    ...
    with HookTimer("tool_redirect", "PreToolUse") as t:
        try:
        ...
        t.set(message="no redirect rules matched", decision="allow")
        return 0
