...
${CLAUDE_PLUGIN_ROOT}/hooks/scripts/update-spec-index.sh
```
...
- /curdx:new <name> - Create new spec
- /curdx:<phase> - Run phase for active spec
- /curdx:status --update-index - Refresh spec index
```
