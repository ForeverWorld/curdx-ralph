...
Examples:
  /curdx:switch feature-b
  /curdx:switch api-auth
  /curdx:switch ./packages/api/specs/api-auth  (full path for disambiguation)
```
...
To create a new spec:
  ...
  /curdx:new my-feature --specs-dir ./packages/api/specs
```
...
1. ./specs/api-auth
   ...
   Run: /curdx:switch ./specs/api-auth

2. ./packages/api/specs/api-auth
   Location: packages/api
   Run: /curdx:switch ./packages/api/specs/api-auth
...
To see available specs: /curdx:switch
To create a new spec: /curdx:new my-feature
```
...
Next: Run /curdx:<appropriate-phase> to continue
```
