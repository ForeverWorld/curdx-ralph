...
- **`/curdx:hookify-help`** - Show this help (what you're reading now)
- **`/curdx:hookify-list`** - List all configured hooks
- **`/curdx:hookify-configure`** - Enable/disable existing hooks interactively
