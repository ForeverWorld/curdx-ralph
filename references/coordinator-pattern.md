...
2. Suggest: "Run /curdx:implement to reinitialize execution state"
...
2. Suggest: "Run /curdx:tasks to generate task list"
3. Do NOT continue execution
4. Do NOT output ALL_TASKS_COMPLETE
...
2. Suggest: "Run /curdx:new <spec-name> to create a new spec"
3. Do NOT continue execution
4. Do NOT output ALL_TASKS_COMPLETE
...
5. **Update Spec Index** (marks spec as completed):
   ```bash
   ${CLAUDE_PLUGIN_ROOT}/hooks/scripts/update-spec-index.sh --quiet
   ```
...
This signal terminates the CURDX Loop.
